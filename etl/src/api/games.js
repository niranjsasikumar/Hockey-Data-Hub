...
export async function getScheduleData(seasons) {
...
export async function getSeasonSchedule(season) {
  const playoffsExpand = PLAYOFFS_DATA_SEASONS.includes(season)
    ? ",schedule.game.seriesSummary,seriesSummary.series,series.round"
    : "";
...
export async function extractGameData(season, game) {
