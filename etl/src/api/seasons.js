...
export async function getSeasonData(seasons) {
...
export function extractSeasonData(seasonData, standingsData, playoffsData) {
...
export function getSeasonStructure(standingsData) {
...
export function getPlayoffRounds(playoffsData) {
